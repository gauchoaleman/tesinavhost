...
$query = "UPDATE Eventos SET Nombre='$Nombre',Descripcion='$Descripcion',Costo='$Costo',
Fecha='$Year-$Month-$Day',Hora='$Hour:$Minute',Administradores_Id=$Administradores_Id,
Salas_Id=$Salas_Id,LinkFacebook='$LinkFacebook',LinkTwitter='$LinkTwitter',LinkInstagram='$LinkInstagram';";

...
CREATE TABLE IF NOT EXISTS `script_tesina`.`Entradas` (
  ...
  `Estado` ENUM('Libre', 'Impresa', 'Vendida', 'Devuelta') NULL,
  `Nro` INT NOT NULL,
...
START TRANSACTION;
USE `script_tesina`;
INSERT INTO `script_tesina`.`Eventos` (`Eventos_Id`, `Nombre`, `Descripcion`, `Costo`, `Fecha`, `Hora`, `Administradores_Id`, `Salas_Id`) VALUES (1, 'Almafuerte', 'Recital de Almafuerte, con sus éxitos de ahora y siempre.  Metal puro y nacional.', 450, '2018-11-22', '23:00', 1, 1);
...
START TRANSACTION;
USE `script_tesina`;
INSERT INTO `script_tesina`.`Entradas` (`Entradas_Id`, `Eventos_Id`, `Estado`, `Nro`) VALUES (1, 1, 'Libre', 1);
INSERT INTO `script_tesina`.`Entradas` (`Entradas_Id`, `Eventos_Id`, `Estado`, `Nro`) VALUES (2, 1, 'Libre', 2);

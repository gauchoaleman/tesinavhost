<?php
$ListaEventosquery = "SELECT s.Calle as SalaCalle,s.AlturaCalle as SalaAlturaCalle,e.Fecha as FechaEvento,e.Hora as HoraEvento,e.Nombre as NombreEvento,e.Descripcion as DescripcionEvento,s.Descripcion as DescripcionSala,e.Eventos_Id as Eventos_Id FROM Eventos e,Salas s WHERE s.Salas_Id=e.Salas_Id";
